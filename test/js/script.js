let scoreOnline, canvas, screen, time, precTime, buttons, selected, start, startImg, smallImg, bigImg, smallTxt, bigTxt, alertText, scoreBoard, play, modal, weather, user, alertUser, restart, alertScreen;
...
let scoreURL = "score.json";
let scoreRequest = new XMLHttpRequest();
scoreRequest.open('GET', scoreURL);
