...
let playerHealth = 1250, botHealth = 1250;
...
function reset () {
	...
	setTimeout(function () {
		...
		alertText.innerHTML = "";
		playerHealth = 1250, botHealth = 1250;
...
function draw () {
	...
	screen.drawImage(healthBarBot, 0, ((1250-botHealth)/2.5), 50, 500, 1050, ((1250-botHealth)/2.5), 50, 500);
	screen.drawImage(healthBarPlayer, 0, ((1250-playerHealth)/2.5), 50, 500, 0, ((1250-playerHealth)/2.5), 50, 500);
